...
<div class="vb-sec card p-4 mb-3" id="tab-financiamento">
  ...
  <div id="finInputs" style="{% if dados.usar_financiamento != '1' %}opacity:.4;pointer-events:none;{% endif %}">
    ...
    <div class="vb-row">
      <div><div class="vb-lbl">Carência (meses)</div><input class="vb-inp" type="number" name="carencia_meses" id="inputCarencia" step="1" min="0" placeholder="6" value="{{ dados.carencia_meses or '6' }}" oninput="checkCarencia(this)"><div class="vb-hint">Meses de juros apenas (sem amortizar) após término da obra</div>
