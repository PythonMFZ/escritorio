...
<aside id="app-sidebar">
  ...
  <div class="sb-section">
    ...
    <a class="sb-link" href="/admin/leads-credito" data-sbpath="/admin/leads-credito" title="Leads Crédito">
      <span class="sb-icon">💰</span><span class="sb-label">Leads Crédito</span>
    </a>
    <a class="sb-link" href="/admin/taxas-bc" data-sbpath="/admin/taxas-bc" title="Taxas BC">
      <span class="sb-icon">📊</span><span class="sb-label">Taxas BC</span>
    </a>
